The Document 'Hands on IoT Lab v10' is a set of instructions to configure an MXChip device to send telemetry to a Remote Monitoring solution to be displayed on the dashboard.
